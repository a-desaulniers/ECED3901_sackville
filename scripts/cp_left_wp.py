...
def main():
    ...
    inspection_route = [
        ...
        #[f2m(12.5), -f2m(0.4), -1.57], # Ram cargo (Hopefully acquire)
        [f2m(11.2), -f2m(0.4), 3.14], # Look away to dump 1st cargo
        [f2m(6.0), f2m(3.0) -f2m(13.5/12.0), 3.14], # RR
        [-f2m(0.5), -f2m(0.5), 3.14]		    # RR
    ]
